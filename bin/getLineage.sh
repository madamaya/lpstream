...
echo "java -cp ../target/l3stream-1.0-SNAPSHOT.jar com.madamaya.l3stream.getLineage.ReplayMonitor $2 $3 $5"
java -cp ../target/l3stream-1.0-SNAPSHOT.jar com.madamaya.l3stream.getLineage.ReplayMonitor $2 $3 $5
