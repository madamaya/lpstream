...
echo "(java -cp ${JAR_PATH} com.madamaya.l3stream.getLineage.ReplayMonitorV2 ${outputTs} ${lineageTopicName} ${outputValue} ${query} ${size} ${experimentID} ${parallelism} &)"
java -cp ${JAR_PATH} com.madamaya.l3stream.getLineage.ReplayMonitorV2 ${outputTs} ${lineageTopicName} ${outputValue} ${query} ${size} ${experimentID} ${parallelism} &
