...
public class ConvertJsonDataRealTh2 extends RichMapFunction<ObjectNode, ReviewInputData> {
    long start;
    long count;
    Params params;

    public ConvertJsonDataRealTh2(Params params) {
        this.params = params;
    }
    ...
    public void close() throws Exception {
        ...
        PrintWriter pw = new PrintWriter(System.getenv("HOME") + "/logs/real_baseline/throughput" + getRuntimeContext().getIndexOfThisSubtask() + "_" + end + "_" + params.getCommentLen() + "_" + params.getSleepTime() + "_" + params.getType() + "_" + params.getWindowSize() + ".log");
