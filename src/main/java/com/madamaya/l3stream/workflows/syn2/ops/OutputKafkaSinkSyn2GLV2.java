...
public class OutputKafkaSinkSyn2GLV2 implements KafkaRecordSerializationSchema<SynJoinedTupleGL> {
    private String topic;
    private GenealogGraphTraverser genealogGraphTraverser;

    public OutputKafkaSinkSyn2GLV2(String topic, ExperimentSettings settings) {
        this.topic = topic;
