...
public class LineageKafkaSinkSyn5GLV2 implements KafkaRecordSerializationSchema<SynJoinedTupleGL> {
    private String topic;
    private GenealogGraphTraverser genealogGraphTraverser;

    public LineageKafkaSinkSyn5GLV2(String topic, ExperimentSettings settings) {
        this.topic = topic;
