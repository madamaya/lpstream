package com.madamaya.l3stream.workflows.unused.syn2.ops;
...
public class LineageKafkaSinkSyn2GLV2 implements KafkaRecordSerializationSchema<SynJoinedTupleGL> {
    private String topic;
    private GenealogGraphTraverser genealogGraphTraverser;

    public LineageKafkaSinkSyn2GLV2(String topic, ExperimentSettings settings) {
        this.topic = topic;
