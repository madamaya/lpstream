...
import com.madamaya.l3stream.workflows.unused.syn4.ops.TsAssignPowerMapL3;
import com.madamaya.l3stream.workflows.unused.syn4.ops.TsAssignTempMapL3;
...
public class L3Syn6 {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<L3StreamTupleContainer<SynTempTuple>> temp = ds
                ...
                .map(L3.mapTs(new TsAssignTempMapL3())).uid("TsAssignTempMap");
        ...
        if (settings.isInvokeCpAssigner()) {
            ...
            joined.sinkTo(settings.getKafkaSink().newInstance(outputTopicName, brokers, settings, true)).uid(settings.getLineageMode());
        }
