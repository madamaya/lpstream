package com.madamaya.l3stream.workflows.unused.nexmark4.ops;
...
public class JoinNexGL4 implements JoinFunction<NexmarkAuctionTupleGL, NexmarkBidTupleGL, NexmarkJoinedTupleGL> {
    @Override
