...
public class LineageKafkaSinkSyn6GLV2 implements KafkaRecordSerializationSchema<SynJoinedTupleGL> {
    private String topic;
    private GenealogGraphTraverser genealogGraphTraverser;

    public LineageKafkaSinkSyn6GLV2(String topic, ExperimentSettings settings) {
        this.topic = topic;
