...
public class OutputKafkaSinkNexmarkGLV2 implements KafkaRecordSerializationSchema<NexmarkJoinedTupleGL> {
    private String topic;
    private GenealogGraphTraverser genealogGraphTraverser;

    public OutputKafkaSinkNexmarkGLV2(String topic, ExperimentSettings settings) {
        this.topic = topic;
