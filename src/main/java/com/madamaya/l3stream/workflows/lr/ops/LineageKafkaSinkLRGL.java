...
public class LineageKafkaSinkLRGL implements KafkaSerializationSchema<CountTupleGL> {
    private String topic;
    private GenealogGraphTraverser genealogGraphTraverser;

    public LineageKafkaSinkLRGL(String topic, ExperimentSettings settings) {
        this.topic = topic;
