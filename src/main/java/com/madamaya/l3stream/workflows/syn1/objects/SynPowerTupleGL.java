...
public class SynPowerTupleGL extends SynPowerTuple implements GenealogTuple {
    ...
    public SynPowerTupleGL(int type, int machineId, double power, String log, long timestamp, long dominantOpTime, long kafkaAppendTime, long stimulus) {
        super(type, machineId, power, log, timestamp, dominantOpTime, kafkaAppendTime, stimulus);
    }
    ...
    public SynPowerTupleGL(SynPowerTupleGL tuple) {
        super(tuple.getType(), tuple.getMachineId(), tuple.getPower(), tuple.getLog(), tuple.getTimestamp(), tuple.getDominantOpTime(), tuple.getKafkaAppendTime(), tuple.getStimulus());
    }
